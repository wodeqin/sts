...
<LINK href="/static/css/jquery.selectbox.css" rel="stylesheet" type="text/css"
	media="all">
<LINK href="/static/css/slidebars.css" rel="stylesheet" type="text/css"
	media="all">
<LINK href="/static/css/main.css" rel="stylesheet" type="text/css" media="all">
<LINK href="/static/css/responsive.css" rel="stylesheet" type="text/css"
	media="all">
<LINK href="/static/css/relatedlink.css" rel="stylesheet" type="text/css"
	media="all">
		...
		<HEADER id="header">
			<DIV class="top-header">
				<DIV class="container">
					...
					<DIV class="logo">
						<A href=""><IMG src="/static/img/logo.svg">
						</A>
					</DIV>
					<DIV class="r-header">
						<UL class="only-pc">
